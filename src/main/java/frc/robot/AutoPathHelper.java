...
public class AutoPathHelper {
    ...
    public static Path getPath(PATH_TYPE pathType) {
        ...
        case RIGHT_CARGOBAY_1: {
            path = new Path(false, false, Constants.kMaxAccelSpeedUp);
        ...
        case RIGHT_ROCKET_1: {
            path = new Path();
            Segment seg1 = new LineSegment(new Point(66.867, 207.362), new Point(155.107, 207.362), 50, 50);
            path.addSegment(seg1);
            Segment seg2 = new ArcSegment(new Point(155.107, 207.362), new Point(185.846, 227.809), new Point(155.107, 240.692), 50);
            path.addSegment(seg2);
            Segment seg3 = new ArcSegment(new Point(185.846, 227.809), new Point(243.943, 233.966), new Point(216.586, 214.927), 50);
            path.addSegment(seg3);
            Segment seg4 = new ArcSegment(new Point(243.943, 233.966), new Point(287.356, 282.213), new Point(271.299, 253.006), 50, 50, ArcSegment.TURN.LARGE_SIDE);
            path.addSegment(seg4);
            Segment seg5 = new LineSegment(new Point(287.356, 282.213), new Point(276.84, 287.994), 50, 0);
            path.addSegment(seg5);
            return path;
        } case RIGHT_ROCKET_2: {
            path = new Path(false, true, Constants.kMaxAccelSpeedUp);
            Segment seg1 = new LineSegment(new Point(261.146, 296.622), new Point(280.288, 286.132), -50);
            path.addSegment(seg1);
            Segment seg2 = new ArcSegment(new Point(280.288, 286.132), new Point(264.871, 226.321), new Point(264.871, 258.198), -50);
            path.addSegment(seg2);
            Segment seg3 = new LineSegment(new Point(264.871, 226.321), new Point(200.931, 226.321), -50);
            path.addSegment(seg3);
            Segment seg4 = new ArcSegment(new Point(200.931, 226.321), new Point(149.224, 174.615), new Point(200.931, 174.615), -50);
            path.addSegment(seg4);
            Segment seg5 = new LineSegment(new Point(149.224, 174.615), new Point(149.224, 162.615), -50, 0);
            path.addSegment(seg5);
            return path;
        } case RIGHT_ROCKET_3: {
            path = new Path();
            Segment seg1 = new LineSegment(new Point(149.224, 162.615), new Point(149.224, 220.28), 50, 50);
            path.addSegment(seg1);
            Segment seg2 = new ArcSegment(new Point(149.224, 220.28), new Point(71.589, 297.916), new Point(71.589, 220.28), 50);
            path.addSegment(seg2);
            Segment seg3 = new LineSegment(new Point(71.589, 297.916), new Point(36.316, 297.916), 50, 0);
            path.addSegment(seg3);
            return path;
        } case RIGHT_ROCKET_4: {
            path = new Path(false, true, Constants.kMaxAccelSpeedUp);
            Segment seg1 = new LineSegment(new Point(18.859, 297.916), new Point(71.589, 297.916), -50);
            path.addSegment(seg1);
            Segment seg2 = new ArcSegment(new Point(71.589, 297.916), new Point(149.224, 220.28), new Point(71.589, 220.28), -50);
            path.addSegment(seg2);
            Segment seg3 = new LineSegment(new Point(149.224, 220.28), new Point(149.224, 162.615), -50, 0);
            path.addSegment(seg3);
            return path;
        } case RIGHT_ROCKET_5: {
            path = new Path();
            Segment seg1 = new LineSegment(new Point(149.224, 162.615), new Point(149.224, 242.914), 50, 50);
            path.addSegment(seg1);
            Segment seg2 = new ArcSegment(new Point(149.224, 242.914), new Point(172.13, 281.886), new Point(193.83, 242.914), 50);
            path.addSegment(seg2);
            Segment seg3 = new LineSegment(new Point(172.13, 281.886), new Point(182.614, 287.742), 50, 0);
            path.addSegment(seg3);
            return path;
        }
